class ApplicationController < ActionController::Base
  ...
  def setup_widgets
    ...
    @recent_pomodoros = Pomodoro.select("pomodoros.id, pomodoros.activity_id, pomodoros.created_at, pomodoros.successful, pomodoros.completed").order("created_at DESC").group("activity_id").limit(5)
